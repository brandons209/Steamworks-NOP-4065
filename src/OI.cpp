...
#include "Commands/ToggleCommands/Intake.h"
#include "Commands/ToggleCommands/IntakeStop.h"
...
OI::OI() {
    ...
    intakeToggle.reset(new ToggledPressedButtonScheduler(intakeBalls->Grab(), intakeBalls.get(), new Intake(), new IntakeStop()));
    intakeToggle->Start();
