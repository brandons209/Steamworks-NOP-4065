...
void RobotMap::init() {
    ...
    driveTrainrightFront.reset(new CANTalon(1));
    ...
    launcherlauncherMotor.reset(new CANTalon(7));
    lw->AddActuator("Launcher", "launcherMotor", launcherlauncherMotor);
    
    launcherangleChanger.reset(new CANTalon(6));
    ...
    loaderloadIt.reset(new CANTalon(5));
